...
<div
  ...
  class="px-1 py-2 rounded-md text-sm font-medium text-center cursor-pointer text-nowrap transition-colors flex-1 flex items-center justify-center gap-1 lg:gap-2"
