...
@php
  $variantStyles = [
    'default' => 'border border-gray-300 dark:border-0 text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700',
  ...
  $classes = 'p-4 rounded-md ' . $variantStyles[$type];
@endphp

<div class="p-4 rounded-md {{ $classes }} flex items-center gap-2">
