<div 
  ...
  "
  class="absolute md:static min-h-full py-4 px-1 sm:px-2 md:px-4 lg:px-10 border-r border-gray-200 dark:border-slate-700 space-y-4 bg-white dark:bg-slate-800"
>
  <button
